 ...
 *       &lt;sequence>
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pain.008.002.02}ExternalCategoryPurpose1Code"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@Entity(name = "CategoryPurposeSEPA")
@Table(name = "CATEGORYPURPOSESEPA")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CategoryPurposeSEPA)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CategoryPurposeSEPA that = ((CategoryPurposeSEPA) object);
        {
            String lhsCd;
            lhsCd = this.getCd();
            String rhsCd;
