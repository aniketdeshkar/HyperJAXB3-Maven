...
@Entity(name = "LocalInstrumentSEPA")
@Table(name = "LOCALINSTRUMENTSEPA")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LocalInstrumentSEPA)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LocalInstrumentSEPA that = ((LocalInstrumentSEPA) object);
        {
            LocalInstrumentSEPACode lhsCd;
            lhsCd = this.getCd();
            LocalInstrumentSEPACode rhsCd;
            rhsCd = that.getCd();
