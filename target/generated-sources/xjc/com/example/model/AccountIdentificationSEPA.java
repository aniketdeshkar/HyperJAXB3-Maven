...
@Entity(name = "AccountIdentificationSEPA")
@Table(name = "ACCOUNTIDENTIFICATIONSEPA")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AccountIdentificationSEPA)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AccountIdentificationSEPA that = ((AccountIdentificationSEPA) object);
        {
            String lhsIBAN;
