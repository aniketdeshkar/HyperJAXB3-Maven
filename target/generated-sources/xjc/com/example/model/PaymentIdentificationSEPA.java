...
@Entity(name = "PaymentIdentificationSEPA")
@Table(name = "PAYMENTIDENTIFICATIONSEPA")
    ...
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Basic
    @Column(name = "INSTRID", length = 255)
     ...
     */
    @Basic
    @Column(name = "ENDTOENDID", length = 255)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PaymentIdentificationSEPA)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PaymentIdentificationSEPA that = ((PaymentIdentificationSEPA) object);
        {
            String lhsInstrId;
