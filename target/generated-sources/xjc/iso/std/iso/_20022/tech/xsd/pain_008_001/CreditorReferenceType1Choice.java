...
@Entity(name = "CreditorReferenceType1Choice")
@Table(name = "CREDITORREFERENCETYPE1CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreditorReferenceType1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreditorReferenceType1Choice that = ((CreditorReferenceType1Choice) object);
        {
            String lhsPrtry;
        ...
        {
            DocumentType3Code lhsCd;
            lhsCd = this.getCd();
            DocumentType3Code rhsCd;
            rhsCd = that.getCd();
