...
@Entity(name = "ClearingSystemIdentification2Choice")
@Table(name = "CLEARINGSYSTEMIDENTIFICATION_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ClearingSystemIdentification2Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ClearingSystemIdentification2Choice that = ((ClearingSystemIdentification2Choice) object);
        {
            String lhsPrtry;
