...
@Entity(name = "FinancialIdentificationSchemeName1Choice")
@Table(name = "FINANCIALIDENTIFICATIONSCHEM_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FinancialIdentificationSchemeName1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FinancialIdentificationSchemeName1Choice that = ((FinancialIdentificationSchemeName1Choice) object);
        {
            String lhsPrtry;
