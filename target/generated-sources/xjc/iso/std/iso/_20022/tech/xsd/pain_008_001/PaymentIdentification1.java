...
@Entity(name = "PaymentIdentification1")
@Table(name = "PAYMENTIDENTIFICATION1_0")
    ...
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Basic
    @Column(name = "ENDTOENDID", length = 35)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PaymentIdentification1)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PaymentIdentification1 that = ((PaymentIdentification1) object);
        {
            String lhsInstrId;
