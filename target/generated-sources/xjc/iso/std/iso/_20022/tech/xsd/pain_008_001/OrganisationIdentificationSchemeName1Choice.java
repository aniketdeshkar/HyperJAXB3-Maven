...
@Entity(name = "OrganisationIdentificationSchemeName1Choice")
@Table(name = "ORGANISATIONIDENTIFICATIONSC_2")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OrganisationIdentificationSchemeName1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OrganisationIdentificationSchemeName1Choice that = ((OrganisationIdentificationSchemeName1Choice) object);
        {
            String lhsPrtry;
