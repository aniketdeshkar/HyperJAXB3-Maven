...
@Entity(name = "Authorisation1Choice")
@Table(name = "AUTHORISATION1CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Authorisation1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Authorisation1Choice that = ((Authorisation1Choice) object);
        {
            String lhsPrtry;
        ...
        {
            Authorisation1Code lhsCd;
            lhsCd = this.getCd();
            Authorisation1Code rhsCd;
            rhsCd = that.getCd();
