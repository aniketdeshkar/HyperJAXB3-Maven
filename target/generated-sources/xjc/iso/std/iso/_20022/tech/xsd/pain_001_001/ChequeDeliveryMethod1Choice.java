...
@Entity(name = "ChequeDeliveryMethod1Choice")
@Table(name = "CHEQUEDELIVERYMETHOD1CHOICE")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ChequeDeliveryMethod1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ChequeDeliveryMethod1Choice that = ((ChequeDeliveryMethod1Choice) object);
        {
            String lhsPrtry;
        ...
        {
            ChequeDelivery1Code lhsCd;
            lhsCd = this.getCd();
            ChequeDelivery1Code rhsCd;
            rhsCd = that.getCd();
