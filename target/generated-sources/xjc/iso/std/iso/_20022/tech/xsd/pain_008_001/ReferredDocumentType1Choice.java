...
@Entity(name = "ReferredDocumentType1Choice")
@Table(name = "REFERREDDOCUMENTTYPE1CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReferredDocumentType1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReferredDocumentType1Choice that = ((ReferredDocumentType1Choice) object);
        {
            String lhsPrtry;
        ...
        {
            DocumentType5Code lhsCd;
            lhsCd = this.getCd();
            DocumentType5Code rhsCd;
            rhsCd = that.getCd();
