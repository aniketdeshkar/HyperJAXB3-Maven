...
@Entity(name = "AccountSchemeName1Choice")
@Table(name = "ACCOUNTSCHEMENAME1CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AccountSchemeName1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AccountSchemeName1Choice that = ((AccountSchemeName1Choice) object);
        {
            String lhsPrtry;
