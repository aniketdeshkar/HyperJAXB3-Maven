...
@Entity(name = "ServiceLevel8Choice")
@Table(name = "SERVICELEVEL8CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ServiceLevel8Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ServiceLevel8Choice that = ((ServiceLevel8Choice) object);
        {
            String lhsPrtry;
