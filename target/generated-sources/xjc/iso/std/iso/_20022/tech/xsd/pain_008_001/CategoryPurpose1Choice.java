...
@Entity(name = "CategoryPurpose1Choice")
@Table(name = "CATEGORYPURPOSE1CHOICE_0")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CategoryPurpose1Choice)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CategoryPurpose1Choice that = ((CategoryPurpose1Choice) object);
        {
            String lhsPrtry;
